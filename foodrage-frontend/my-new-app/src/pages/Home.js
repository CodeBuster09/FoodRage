...
import inHonorof from "../assets/inHonorof.png";
import inMemoryof from "../assets/inMemoryof.png";
import foodGirl from "../assets/Girl-Food.png";
import family from "../assets/family.png";
import FoodHandout from "../assets/Food-Handout.jpg";
                  ...
                  <div className="flex gap-6  md:gap-10 md:10">
                    <div className="flex justify-center items-center gap-1 flex-col">
                      <img
                        ...
                        alt="Celebration"
                      />
                      <p className="text-white">Celebration</p>
                    </div>
                    <div className="flex justify-center items-center gap-1 flex-col">
                      <img
                        className=" md:w-20  w-16"
          ...
          <div className="container">
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
              ...
              <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                <a
                  href="https://www.facebook.com/valay.khbrgde"
                ...
                <a
                  href="https://twitter.com/valay_khbrgde"
                  className="text-gray-500 hover:text-gray-900 dark:hover:text-white"
                >
                  <svg
                    className="w-5 h-5"
              ...
              aria-hidden="true"
               >
    <path d="M19.615 3.184C21.375 3.528 22.5 5.02 22.5 6.833v10.333c0 1.814-1.125 3.305-2.885 3.649C16.623 21 12 21 12 21s-4.623 0-7.615-.184C2.625 20.47 1.5 18.98 1.5 17.167V6.833C1.5 5.02 2.625 3.528 4.385 3.184 7.377 3 12 3 12 3s4.623 0 7.615.184zM10 8.25v7.5L16 12l-6-3.75z" />
  </svg>
